...
import { Utensils, Mail, Lock, Eye, EyeOff, ArrowRight, Chrome, Smartphone } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 flex items-center justify-center p-4">
      ...
      >
        <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-orange-100">
          ...
          <p className="text-center text-gray-500 mb-6 text-sm">Sign in to continue your health journey</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPassword ? 'text' : 'password'} required value={password} onChange={e => setPassword(e.target.value)} className="w-full pl-10 pr-10 py-3 rounded-xl border border-gray-200 focus:border-orange-400 focus:ring-2 focus:ring-orange-100 outline-none transition-all bg-white/50" placeholder="Enter password" />
